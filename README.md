...
1. **Context is working memory** — Models perform best with the smallest set of *relevant* evidence. More context is not inherently better; irrelevant context degrades reasoning.
